...
Need to make folders in the the same directory called "Restaurant Choice Files" with restaurant.js in it, "Results Page Files" with results.js in it, and "Waiting Page Files" with waiting.js in it
